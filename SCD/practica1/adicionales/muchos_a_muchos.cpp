...
mostrador) y el array desbloquea que nos servirá para saber qué estanco ha
desbloqueado a qué fumador.
...
IMPORTANTE: El acceso al vector de prioridades tiene que hacerse en exclusión
mutua, si no, los dos estanqueros podrían "escoger" al mismo fumador si
venden el mismo ingrendiente.
**/
